...
This project contains specifications for the u-space data provisionng and exchange between the CIS and USS.

## Geo-Awareness

ED-318 geozones distribution is done through ASTM UTM [F3548-22](https://github.com/interuss/astm-utm-protocol/) Constraints.

The set of changes from the official specification are defined in the OpenAPI overlay [utm-overlay.yaml](./geoawareness/utm-overlay.yaml):
